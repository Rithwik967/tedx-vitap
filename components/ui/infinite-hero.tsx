		...
		>
			...
			<div className="relative z-10 flex h-svh w-full items-center justify-center px-6">
				<div className="text-center">
					...
					>
						Welcome to TEDx VITAP 2024
					</h1>
					<p
						ref={pRef}
						className="mx-auto mt-4 max-w-2xl md:text-balance text-sm/6 md:text-base/7 font-light tracking-tight text-white/70"
					>
						Unfolding Possibilities - Where ideas transcend boundaries and inspire change. 
						Join us for a journey of innovation, inspiration, and impactful ideas.
					</p>
					...
					>
						<a
							href="#about"
							className="group relative overflow-hidden border border-red-500/50 bg-gradient-to-r from-red-500/20 to-red-500/10 px-6 py-3 text-sm rounded-lg font-medium tracking-wide text-white backdrop-blur-sm transition-[border-color,background-color,box-shadow] duration-500 hover:border-red-500 hover:bg-red-500/20 hover:shadow-lg hover:shadow-red-500/20 cursor-pointer"
						>
							Learn More
						</a>
