...
export function RedShaderBackground({
	vertexShader = `
    varying vec2 vUv;
    void main() {
      vUv = uv;
  ...
  `,
    ...
    void mainImage( out vec4 fragColor, in vec2 fragCoord )
    {
      vec2 uv = (fragCoord.xy-.5*u_resolution.xy)/u_resolution.y;
        ...
        // Convert to red color scheme for TEDx branding
        vec3 col = vec3(f * 0.9, f * 0.1, f * 0.1); // Red dominant
        col = mix(col, vec3(0.9, 0.1, 0.1), f * 0.3); // Add more red intensity
